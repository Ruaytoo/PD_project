...
Payoff::Payoff (float dd, float dc, float cd, float cc, float p):
distr (0, C)
{
  this->dd = dd;
  this->dc = dc;
...
void
Payoff::UpdateScore (Agent * agent1, Agent * agent2, float score1,
...
void
Payoff::compute_score (Agent * agent1, Agent * agent2)
{
